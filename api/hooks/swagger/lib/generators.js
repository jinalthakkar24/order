        ...
        _.forEach(routes, function (route) {
          ...
          if(!route.custom){ // if not from routes.js use the default custom blueprint maps
            ...
            if (!parameter) { //which means is not in our parameters, then use the keys to get and add token for us incase of any route using header information
                ...
                parameter.push({$ref: '#/parameters/ConferenceId'});
            }
            ...
            var path = {
                ...
                responses: {
                    ...
                    '201': {description: 'The requested resource created'},
                    '400': {description: 'The requested resource has bad request params'},
                    '401': {description: 'The requested resource is unauthorised'},
                    '403': {description: 'Resource is forbidden'},
