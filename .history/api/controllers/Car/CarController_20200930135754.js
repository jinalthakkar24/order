        ...
        try {
            ...
            if (car && car.id) {
                ...
                if (response && response.length) {
                    ...
                    let message = updatedCar && !_.isNull(updatedCar.parentId) ? sails.config.message.SUB_MASTER_UPDATED : sails.config.message.MASTER_UPDATED;
                    return res.ok(updatedCar, message)
                }
            }
            else {
